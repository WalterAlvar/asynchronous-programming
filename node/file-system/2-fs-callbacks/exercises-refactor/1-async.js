...
log(3, yourGuess);
const callbackContent1 = (fileContents1) => {
    const callbackContent2 = (fileContents2)=>{
        log(6, 'comparing file contents ...', callbackContent2);
...
log(4, `reading ${fileName1} ...`, callbackContent1 );
